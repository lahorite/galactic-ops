...
st.caption("Health panel for a single spacecraft — fuel, solar, battery, thermal, and comms")
...
# -----------------------------
st.markdown("### 📈 Realtime Telemetry Trends")
...
# -----------------------------
st.markdown("### 📟 Alerts & System Console")
